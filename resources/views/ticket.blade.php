      ...
      <div class="container h-100">
        <div class="row h-100 align-items-center">
          <div class="col-12 text-center">
            <h1 class="fw-normal display-3"><b>BOOKING TICKET</b></h1>
          </div>
        </div>
      </div>
    </header>
...
<!-- Page Content -->
    <section class="container py-5">
      <h2 class="pb-2 border-bottom fw-bold text-uppercase text-center ">Harga Ticket</h2>
      <table class="container table w-75 p-5 table align-middle">
        <thead class="table-dark table align-middle" style="text-align: center">
          <tr>
            <th scope="col">Jenis Ticket</th>
            <th scope="col">Senin - Kamis</th>
            <th scope="col">Sabtu - Minggu / Tanggal Merah</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td>Tiket Masuk Reguler Gratis 3 Wahana</td>
            <td style="text-align: center">Rp 35.000</td>
            <td style="text-align: center">Rp 40.000</td>
          </tr>
          <tr>
            <td>Tiket Masuk Terusan (Gratis 31 Wahana)</td>
            <td style="text-align: center">Rp 110.000</td>
      ...
      @csrf
        <div class="container w-50 p-5">
          <h2 class="pb-2 border-bottom fw-bold text-uppercase text-center ">Pesan Ticket</h2>
          ...
          <div class="mb-3">
          <label for="FormControl" class="form-label">Tiket</label>
          <select class="form-select" aria-label="Default select example">
            <option selected>Jenis Tiket</option>
            <option value="1">Tiket Masuk Reguler Gratis 3 Wahana</option>
            <option value="2">Tiket Masuk Terusan (Gratis 31 Wahana)</option>
          </select>
          </div>
          <div class="d-grid gap-2 col-6 mx-auto">
            <button type="submit" class="btn btn-md btn-primary">Booking</button>
          </div>
        </div>
      </form>   
    </section>
